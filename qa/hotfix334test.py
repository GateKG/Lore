...
check("lore.py APP_VERSION 3.36", 'APP_VERSION = "3.36"' in SRC)
check("ui.html version:'3.36' x2, no 3.35 stamp left",
      USRC.count("version:'3.36'") == 2 and "version:'3.35'" not in USRC)
check("version.txt 3.36", "filevers=(3, 36, 0, 0)" in VT
      and "prodvers=(3, 36, 0, 0)" in VT and VT.count("'3.36.0.0'") == 2
      and "3, 33" not in VT and "3.33" not in VT)
check("installer.iss 3.36", "AppVersion=3.36\n" in ISS.replace("\r\n", "\n")
